...
- (IBAction)calculatePressed:(id)sender {
 ...
 //NSLog(@"%f",p.heightInM.doubleValue);
  ...
  if(bmi.doubleValue <18.5){
    ...
    self.week = @(( self.properWeight.floatValue - p.weightInKG.floatValue )/0.45);
    ...
    self.week = @((p.weightInKG.floatValue - self.properWeight.floatValue )/0.45);
